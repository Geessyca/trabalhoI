...
class AtuadoresBD:
    ...
    def get(self):
        try:
            ...
            query = "SELECT * FROM atuadores ORDER BY Id DESC LIMIT 1"
    ...
    def post(self, sensor1, sensor2, angulo):
        try:
            if not self.conn:
                self.conectar()

            consulta = "INSERT INTO atuadores (sensor1, sensor2, angulo) VALUES (%s, %s, %s)"
            valores = (sensor1, sensor2, angulo)
